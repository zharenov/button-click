...
public class BcTestContainer extends TestContainer {

    public BcTestContainer() {
        super();
    ...
    public static class Common extends BcTestContainer {

        public static final BcTestContainer.Common INSTANCE = new BcTestContainer.Common();
